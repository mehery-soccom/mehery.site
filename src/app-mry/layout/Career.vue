                ...
                <div class="container mx-auto">
                    ...
                    <div class="space-y-6 mb-8">
                        ...
                        <p class="text-gray-600 text-base sm:text-lg">
                            At Mehery, we believe in the power of conversations—not just with customers, but within our team. We are a young, fast-growing organization that thrives on innovation, collaboration, and a shared passion for simplifying customer engagement.
                        </p>
                    </div>
                    ...
                    <div class="space-y-6 mb-8">
                        ...
                        <p class="text-gray-600 text-base sm:text-lg">
                            We’re always on the lookout for passionate and talented individuals. Drop your resume at <a href="mailto:hr@mehery.com" class="text-blue-600 hover:underline">hr@mehery.com</a> and let us know how you can contribute!
                        </p>
                    </div>
                </div>
            </section>

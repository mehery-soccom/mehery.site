<template>
    <div @click="handleClickOutside" class="font-sans chatbot-container">
        ...
        <div class="bottom-44 right-6 group chatbot-element">
            <!-- Tooltip -->
            <div
                class="absolute -top-0 right-20 bg-gray-800 text-white text-xs py-1 rounded w-auto px-2 whitespace-nowrap chatbot-tooltip"
            >
                Chat with us
            </div>
            <!-- Bot Button -->
        ...
        <transition name="slide-fade">
            <div
                v-if="isOpen"
                class="fixed bottom-44 right-6 w-80 bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-100 chatbot-popup"
                @click.stop
            >
                ...
                <transition name="fade">
                    <div
                        ...
                        class="absolute inset-0 bg-gradient-to-br from-green-400 to-green-600 z-50 flex flex-col items-center justify-center text-white p-4 pr-10 text-center"
                    >
                        ...
                        <button
                            @click="toggleBot"
                            class="absolute top-4 right-4 text-white hover:text-gray-200 focus:outline-none bg-black bg-opacity-20 rounded-full p-1"
                ...
                <div class="input-container">
                    <input
                        ...
                        class=""
                        @keydown.enter="handleUserResponse"
                    />
...
export default {
    ...
    data() {
        return {
            ...
            userInput: "",
            conversation: [{ type: "bot", text: "Welcome! What is your full name?" }],
            form: {
                name: "",
                email: "",
                phone: ""
    ...
    methods: {
        ...
        resetConversation() {
            this.conversation = [{ type: "bot", text: "Welcome! What is your full name?" }];
            this.currentStep = 0;

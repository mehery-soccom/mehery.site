                        ...
                        <div class="space-y-6 max-w-2xl">
                            ...
                            <div class="space-y-4">
                                <p class="text-gray-600 text-base sm:text-lg">
                                    Capture, categorize, and convert leads effortlessly across social media and messaging platforms. With our intelligent lead management system, transform casual interactions into long-term customer relationships.
                                </p>
                                <ul class="space-y-4">
                                ...
                                <p class="text-gray-600 text-base sm:text-lg font-semibold">
                                    Maximize conversions with an organized, data-driven approach to lead management. Keep your pipeline active and accelerate business growth with ease!
                                </p>
                            </div>
                        </div>
                        <div class="relative -">

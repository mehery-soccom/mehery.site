<template>
    <div class="mx-4 sm:mx-6 md:mx-8 lg:mx-12 py-3 sm:py-5">
        ...
        <!-- BOTs Dynamic Section -->
        <ArticleList :contentType="'servicesBot'" v-slot="{ loading, results }">
            <div v-if="loading" class="col-span-1 sm:col-span-2 flex justify-center py-8">
                ...
                <p class="mt-2 text-gray-600">Loading bots...</p>
                </div>
            </div>
            ...
            <template v-else>
                ...
                <div class="flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-6 pl-6">
                    <div class="flex-1 max-w-full sm:max-w-md">
                        <h2 class="text-lg sm:text-xl font-bold mb-2 sm:mb-3  sm:text-left">{{ item.info.title }}</h2>

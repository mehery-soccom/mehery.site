<template>
  <div class="mx-12 py-3">
    <!-- Header Section -->
    <h1 class="text-3xl mx-4 font-bold mb-2">Solutions</h1>
    <p class="text-gray-600 mb-4 mx-4 max-w-2xl text-md">
      At our digital marketing agency, we offer a range of services to help businesses grow and succeed online. These services include:
    </p>

    <!-- Services Grid -->
    <div class="grid grid-cols-1 md:grid-cols-3 mx-4 gap-4 mb-2">
      <!-- Customer Management -->
      <div 
        @click="handleCustomer"
        class="rounded-2xl bg-blue-50 p-6 text-gray-800 transition-all hover:scale-[1.02] hover:shadow-lg border-b-4 border-blue-200 cursor-pointer h-52"
      >
        <div class="h-28 relative">
          ...
          <img src="../../@assets/images/tokyo-many-browser-windows-with-different-information 1.svg" 
               alt="" 
               class="absolute right-0 top-0 w-32 h-28" />
        </div>
    ...
    <div 
      @click="handleBot"
      class="rounded-2xl bg-emerald-50 px-6 py-3 text-gray-800 mx-4 transition-all hover:scale-[1.02] hover:shadow-lg border-b-4 border-emerald-200 cursor-pointer relative flex justify-between"
    >

<template>
  <div class="relative py-16 bg-gradient-to-br from-gray-50 to-white">
    <div class="max-w-4xl mx-auto px-4">
      ...
      <ArticleList :contentType="'testimonials'" v-slot="{ loading, results }" />
        <div class="relative">
                ...
                <div class="relative z-10">
                  <div class="flex items-center mb-6 space-x-1">
                    <template v-for="i in 5" :key="i">
                      <div :class="i <= currentTestimonial.rating
                          ? 'text-yellow-400'
                          : 'text-gray-200'
                        " class="w-6 h-6">
        ...
        <div class="flex justify-center mt-8 space-x-2">
          <button v-for="(_, index) in testimonials" :key="index" @click="setTestimonial(index)"
            class="w-3 h-3 rounded-full transition-all duration-200 focus:outline-none" :class="currentIndex === index

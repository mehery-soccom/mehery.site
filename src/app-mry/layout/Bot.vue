                            ...
                            <div class="space-y-4">
                                <ul class="space-y-4">
                                    <li class="flex items-start space-x-3">
                                        ...
                                        <div>
                                            <h4 class="text-base font-semibold text-gray-800">
                                                Custom AI Chatbot with Generative AI & LLMs
                                            </h4>
                                            <p class="text-gray-600 text-md">
                                                Infuse ChatGPT-4o’s advanced LLM to create brand-aligned chatbots.
                                                Customize brand tone, voice, and answer length for a unique personality.
                                            </p>
                                        </div>
                                    </li>
                                    <li class="flex items-start space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-600 text-md">
                                                Engage users worldwide with contextual conversations based on real-time
                                                interactions.
                                            </p>
                                        </div>
                                    </li>
                                ...
                                <p class="text-gray-600 text-base sm:text-lg font-semibold">
                                    Empower your business with AI-driven automation that enhances customer experience,
                                    efficiency, and satisfaction at every touchpoint!
                                </p>
                            </div>
                        </div>
                        <div class="relative">

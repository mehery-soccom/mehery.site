<template>
    <section id="landingFunFacts" class="section-py landing-fun-facts">
      <div class="container">
        <div class="row gy-6">
          ...
          >
            <div :class="`card border border-${fact.borderColor} shadow-none`">
              <div class="card-body text-center flex flex-column justify-content-center align-items-center">
                <div :class="`mb-4 text-${fact.borderColor}`" v-html="fact.icon" />
                <h3 class="mb-0">{{ fact.value }}</h3>
                <p class="fw-medium mb-0" v-html="fact.label" />
              </div>
            </div>
          </div>
        </div>
    ...
    data() {
      return {
        facts: [
          {
            value: '7.1k+',
            label: 'Support Tickets<br />Resolved',
            borderColor: 'primary',
          ...
          {
            value: '50k+',
            label: 'Join creatives<br />community',
            borderColor: 'success',
          ...
          {
            value: '4.8/5',
            label: 'Highly Rated<br />Products',
            borderColor: 'info',
            icon: `<svg width="65" height="65" viewBox="0 0 65 65" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    opacity="0.2"
  ...
  <style scoped>
  /* You can keep any scoped custom styles here if needed */
  </style>

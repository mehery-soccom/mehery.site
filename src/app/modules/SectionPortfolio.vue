<template>
    <section class="page-section bg-light" id="portfolio">
            ...
            <b-row>
                <b-col lg="4" sm="6" class="mb-4">
                    ...
                    <div class="portfolio-item">
                        <a class="portfolio-link" v-b-modal="'portfolioModal' + 1">
                            <div class="portfolio-hover">
                                <div class="portfolio-hover-content"><i class="fas fa-plus fa-3x"></i></div>
                            </div>
                            <img class="img-fluid" src="@assets/images/portfolio/1.jpeg" alt="..." />
                        </a>
                ...
                <div class="col-lg-4 col-sm-6 mb-4">
                    ...
                    <div class="portfolio-item">
                        <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal2">
                            ...
                            <img class="img-fluid" src="@assets/images/portfolio/2.jpeg" alt="..." />
                        </a>
                        <div class="portfolio-caption">
                ...
                <div class="col-lg-4 col-sm-6 mb-4">
                    ...
                    <div class="portfolio-item">
                        <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal3">
                            ...
                            <img class="img-fluid" src="@assets/images/portfolio/3.jpeg" alt="..." />
                        </a>
                        <div class="portfolio-caption">
                ...
                <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
                    ...
                    <div class="portfolio-item">
                        <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal4">
                            ...
                            <img class="img-fluid" src="@assets/images/portfolio/4.jpeg" alt="..." />
                        </a>
                        <div class="portfolio-caption">
                ...
                <div class="col-lg-4 col-sm-6 mb-4 mb-sm-0">
                    ...
                    <div class="portfolio-item">
                        <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal5">
                            ...
                            <img class="img-fluid" src="@assets/images/portfolio/5.jpeg" alt="..." />
                        </a>
                        <div class="portfolio-caption">
                ...
                <div class="col-lg-4 col-sm-6">
                    ...
                    <div class="portfolio-item">
                        <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal6">
                            ...
                            <img class="img-fluid" src="@assets/images/portfolio/6.jpeg" alt="..." />
                        </a>
                        <div class="portfolio-caption">
        ...
        <b-modal id="portfolioModal1" size="xl">
            <!-- Project details-->
            <h2 class="text-uppercase">Project Name</h2>
            <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
            <img class="img-fluid d-block mx-auto" src="@assets/images/portfolio/1.jpeg" alt="..." />
            <p>
                            ...
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    ...
                                    <img
                                        ...
                                        src="@assets/images/portfolio/2.jpeg"
                                        alt="..."
                                    />
                                    <p>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    ...
                                    <img
                                        class="img-fluid d-block mx-auto"
                                        src="@assets/images/portfolio/3.jpeg"
                                        alt="..."
                                    />
                                    <p>
                                        Use this area to describe your project. Lorem ipsum dolor sit amet, consectetur
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    ...
                                    <img
                                        class="img-fluid d-block mx-auto"
                                        src="@assets/images/portfolio/4.jpeg"
                                        alt="..."
                                    />
                                    <p>
                                        Use this area to describe your project. Lorem ipsum dolor sit amet, consectetur
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    ...
                                    <img
                                        class="img-fluid d-block mx-auto"
                                        src="@assets/images/portfolio/5.jpeg"
                                        alt="..."
                                    />
                                    <p>
                                        Use this area to describe your project. Lorem ipsum dolor sit amet, consectetur
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    ...
                                    <img
                                        class="img-fluid d-block mx-auto"
                                        src="@assets/images/portfolio/6.jpeg"
                                        alt="..."
                                    />
                                    <p>
                                        Use this area to describe your project. Lorem ipsum dolor sit amet, consectetur
